...
class AppImageMetadata:
    ...
    def parse(self):
        with open(self.path, "rb") as f:
            ...
            self.update_info = self._extract_upd_info(f, is_64, endian, shoff, shentsize, shnum, header)

    def _extract_upd_info(self, f, is_64, endian, shoff, shentsize, shnum, header):
